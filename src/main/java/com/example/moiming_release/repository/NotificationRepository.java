...
public interface NotificationRepository extends JpaRepository<Notification, Long> {
    ...
    // 내가 총무일 때 이미 송신한 msgType 1이 있는지 확인하기 위함.
    Optional<Notification> findBySentSessionUuidAndMoimingUserUuidAndMsgType(UUID sentSessionUuid, UUID receiverUuid, Integer msgType);
